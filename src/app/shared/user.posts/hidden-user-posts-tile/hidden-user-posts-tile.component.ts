...
@Component({
             selector:    'user-post-hidden-tile',
             templateUrl: '../common/base.user.posts.component.html',
             styleUrls:   ['../common/base.user.posts.component.css'],
             providers:   [ConfirmationService]
           })
export class HiddenUserPostsTileComponent extends BaseUserPostsComponent implements OnInit, OnDestroy
{
              ...
              authService: AuthDataService)
  {
    ...
    this.selectedView =  USER_POSTS_TYPES.USER_HIDDEN_POSTS;
  }
