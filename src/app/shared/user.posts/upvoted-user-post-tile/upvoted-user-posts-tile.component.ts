...
@Component({
             selector:    'upvoted-user-posts-tile',
             templateUrl: '../common/base.user.posts.component.html',
             styleUrls:   ['../common/base.user.posts.component.css'],
             providers:   [ConfirmationService]
           })
export class UpVotedUserPostsTileComponent extends BaseUserPostsComponent implements OnInit, OnDestroy
{
              ...
              authService: AuthDataService)
  {
    ...
    this.selectedView = USER_POSTS_TYPES.USER_UP_VOTED_POSTS;
  }
}
