...
//*************************************************************************************************
export function showOperationResultMessages(messageService: MessageService, items: OperationResult[]): void
{
  !isEmptyArray(items) && items.forEach(item => messageService.add({severity: (item.id < 0) ? 'error' : 'success', detail: item.message}));
}

//*************************************************************************************************
export function showWarningMessages(messageService: MessageService, items: OperationResult[]): void
{
  !isEmptyArray(items) && items.forEach(item => messageService.add({severity: 'warn', detail: item.message}));
}

//*************************************************************************************************
export function showErrorMessages(messageService: MessageService, items: OperationResult[]): void
{
  !isEmptyArray(items) && items.forEach(item => messageService.add({severity: 'error', detail: item.message}));
}

//*************************************************************************************************
export function showsInfoMessages(messageService: MessageService, items: OperationResult[]): void
{
  !isEmptyArray(items) && items.forEach(item => messageService.add({severity: 'info', detail: item.message}));
}
