...
export const enum EActionType
{
  ...
  ON_BAN_USER_IN_CHANNEL_ACTION           = 'ON_BAN_USER_IN_CHANNEL_ACTION', // type OnManageUserChannelBanningResult
  ON_ADD_MODERATOR_USER_IN_CHANNEL_ACTION = 'ON_ADD_MODERATOR_USER_IN_CHANNEL_ACTION', // type OnManageUserChannelModeratorResult
}
