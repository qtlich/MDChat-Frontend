...
//*************************************************************************************************
export function showWarningMessages(serviceBus: GlobalBusService, items: OperationResult[]): void
{
  !isEmptyArray(items) && items.forEach(item => serviceBus.showWarning('Warning', toString(item.message)));
}

//*************************************************************************************************
export function showErrorMessages(serviceBus: GlobalBusService, items: OperationResult[]): void
{
  !isEmptyArray(items) && items.forEach(item => serviceBus.showError('Error', toString(item.message)));
}

//*************************************************************************************************
export function showsInfoMessages(serviceBus: GlobalBusService, items: OperationResult[]): void
{
  !isEmptyArray(items) && items.forEach(item => serviceBus.showInfo('Info', toString(item.message)));
}
...
{
  return `${toString(error ? error : error)}`;
}
